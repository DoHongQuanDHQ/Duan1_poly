...
<head>
    ...
    <title>DLSshop</title>
    <link href="./src/css/magiczoomplus-trial/magiczoomplus/magiczoomplus.css" rel="stylesheet" type="text/css"
        media="screen" />
            ...
            <header class="header">
                <div class="grid wide  mid-header">
                    <div class="mid-header__logo">
                        <a href="./index.php"><img src="./src/image/img_header_hoan/image-prod/img1.jpeg" alt=""
                                width="100"></a>
                    </div>
                        ...
                        <a class="mid-header__support__link" href="">
                            <div class="mid-header__support">
                                ...
                                <img class="mid-header__sp__img"
                                    src="./src/image/img_header_hoan/circle-phone-removebg-preview.png" alt="">
